...
class CfgVehicles
{
	...
	class sps_black_hornet_01_Base_F: UAV_01_base_F
	{
		...
		class ACE_Actions
		{
			class ACE_MainActions
			{
				...
				class BFSQN_SPS_BH_Pickup
				{
					...
					icon="\x\BFSQN_PrivateMod\addons\BFSQN_private_drones\SPS_Black_Hornet\data\ui\sps_blackhornet_ca.paa";
		...
		model="\x\BFSQN_PrivateMod\addons\BFSQN_private_drones\SPS_Black_Hornet\sps_blackhornet.p3d";
		driveOnComponent[]={"gear1","gear2"};
		icon="\x\BFSQN_PrivateMod\addons\BFSQN_private_drones\SPS_Black_Hornet\data\ui\sps_blackhornet_map_icon_ca.paa";
		picture="\x\BFSQN_PrivateMod\addons\BFSQN_private_drones\SPS_Black_Hornet\data\ui\sps_blackhornet_ca.paa";
	...
	class sps_black_hornet_01_F: sps_black_hornet_01_Base_F
	{
		...
		{
			"x\BFSQN_PrivateMod\addons\BFSQN_private_drones\SPS_Black_Hornet\data\standard\SPS_BH_low_CO.paa"
		};
		displayName="Black Hornet";
				...
				class ACE_GX_DRONES
				{
					...
					class BFSQN_SPS_BlackHornet
					{
						...
						class BFSQN_SPS_BH_FlyDeploy
						{
							...
							icon="\x\BFSQN_PrivateMod\addons\BFSQN_private_drones\SPS_Black_Hornet\data\ui\interact_hand_deploy_ca.paa";
							condition="[_player] call BFSQN_fnc_sps_bh_canDeploy";
						...
						{
							displayName="Place";
							icon="\x\BFSQN_PrivateMod\addons\BFSQN_private_drones\SPS_Black_Hornet\data\ui\interact_place_floor_ca.paa";
							condition="[_player] call BFSQN_fnc_sps_bh_canDeploy";
...
class CfgWeapons
{
	...
	class sps_black_hornet_01_Static_F: CBA_MiscItem
	{
		...
		displayName="Black Hornet";
		scopeArsenal=2;
		model="\x\BFSQN_PrivateMod\addons\BFSQN_private_drones\SPS_Black_Hornet\sps_blackhornet_static.p3d";
...
class Extended_PreInit_EventHandlers
{
	...
	{
		init="call compile preprocessFileLineNumbers 'x\BFSQN_PrivateMod\addons\BFSQN_private_drones\SPS_Black_Hornet\XEH_preInit.sqf'";
	};
};
