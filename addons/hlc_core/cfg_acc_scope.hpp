...
class HLC_optic_Aimpoint3000 : optic_Arco {
	...
	hiddenSelections[] = { "Camo1"/*Body*/, "Camo2"/*Red Dot*/ };
...
class HLC_optic_Aimpoint3000_Br4 :HLC_optic_Aimpoint3000
{
	...
	hiddenSelectionsTextures[] = {
		"hlc_core\tex\acc\optic\Aimpoints\Map_Optics_Aimpoint3000_Co.paa",
		"hlc_core\tex\acc\optic\Aimpoints\RedDot4_ca.paa"
	};
	HiddenSelectionsMaterials[] = {
		"hlc_core\mat\acc\optic\optics_aimpoint3000.rvmat",
		"a3\weapons_f\acc\data\collimdot_cshader.rvmat",
...
class HLC_optic_Aimpoint3000_Br3 :HLC_optic_Aimpoint3000
{
	...
	hiddenSelectionsTextures[] = {
		"hlc_core\tex\acc\optic\Aimpoints\Map_Optics_Aimpoint3000_Co.paa",
		"hlc_core\tex\acc\optic\Aimpoints\RedDot3_ca.paa"
	};
	HiddenSelectionsMaterials[] = {
		"hlc_core\mat\acc\optic\optics_aimpoint3000.rvmat",
		"a3\weapons_f\acc\data\collimdot_cshader.rvmat",
...
class HLC_optic_Aimpoint3000_Br2 :HLC_optic_Aimpoint3000
{
	...
	hiddenSelectionsTextures[] = {
		"hlc_core\tex\acc\optic\Aimpoints\Map_Optics_Aimpoint3000_Co.paa",
		"hlc_core\tex\acc\optic\Aimpoints\RedDot2_ca.paa"
	};
	HiddenSelectionsMaterials[] = {
		"hlc_core\mat\acc\optic\optics_aimpoint3000.rvmat",
		"a3\weapons_f\acc\data\collimdot_cshader.rvmat",
...
class HLC_optic_Aimpoint3000_Br1 :HLC_optic_Aimpoint3000
{
	...
	hiddenSelectionsTextures[] = {
		"hlc_core\tex\acc\optic\Aimpoints\Map_Optics_Aimpoint3000_Co.paa",
		"hlc_core\tex\acc\optic\Aimpoints\RedDot1_ca.paa"
	};
	HiddenSelectionsMaterials[] = {
		"hlc_core\mat\acc\optic\optics_aimpoint3000.rvmat",
		"a3\weapons_f\acc\data\collimdot_cshader.rvmat",
	...
	class ItemInfo : InventoryOpticsItem_Base_F {
		...
		class OpticsModes
		{
			class ACO
			{
				opticsID = 1;
				useModelOptics = 0;
				opticsZoomMin = __OPTICSMAGFOV(3);
				opticsZoomMax = __OPTICSMAGFOV(3);
				opticsZoomInit = __OPTICSMAGFOV(3);
				memoryPointCamera = "eye";
				opticsFlare = 0;
				discreteDistance[] = { 100,200,300 };
				discreteDistanceInitIndex = 0;
...
class HLC_optic_Aimpoint3000_magnifier_Br4 :HLC_optic_Aimpoint3000_magnifier
{
	...
	// DOESN'T WORK >:|
	hiddenSelectionsTextures[] = {
		"hlc_core\tex\acc\optic\Aimpoints\Map_Optics_Aimpoint3000_magnifier_Co.paa",
		"hlc_core\tex\acc\optic\Aimpoints\RedDot4_ca.paa"
	};
	HiddenSelectionsMaterials[] = {
		"hlc_core\mat\acc\optic\optics_Aimpoint3000_magnifier.rvmat",
		"a3\weapons_f\acc\data\collimdot_cshader.rvmat",
	};*/
};
...
class HLC_optic_Aimpoint5000_magnifier_Br4 :HLC_optic_Aimpoint5000_magnifier
{
	...
	// DOESN'T WORK >:|
	hiddenSelectionsTextures[] = {
		"hlc_core\tex\acc\optic\Aimpoints\Map_Optics_Aimpoint5000_magnifier_Co.paa",
		"hlc_core\tex\acc\optic\Aimpoints\RedDot4_ca.paa"
	};
	HiddenSelectionsMaterials[] = {
		"hlc_core\mat\acc\optic\optics_Aimpoint5000_magnifier.rvmat",
		"a3\weapons_f\acc\data\collimdot_cshader.rvmat",
	};*/
};
